      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {casos.map(caso => {
            ...
            return (
              <div key={caso.id} className={`bg-white rounded-2xl border shadow-sm overflow-hidden transition-all ${caso.estado_general === 'Cerrado' ? 'opacity-60 border-gray-100' : 'border-gray-100 hover:border-gray-200'}`}>
                ...
                >
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    ...
                    {updCount > 0
                      ? <span className="font-semibold text-verde-oscuro">{updCount} actualización{updCount > 1 ? 'es' : ''}</span>
                      : 'Sin actualizaciones'}
                  </div>
